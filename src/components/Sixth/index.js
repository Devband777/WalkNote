...
function sixth() {
  return (
    <div className='sixth'>
      <img src={barImg} className="sixth-bar"/>
      <div className='sixth-left' style={{position:"absoloute"}}>
        <img src={logoImg} className="sixth-logo"/>
        <div className='sixth-left-top-bar'>
        ...
        <div className='sixth-left-bottom-bar'>

        </div>
      </div>
      <div className='sixth-right'>
        <div className='sixth-right-back'>
            <div className='fourth_layer1' style={{position:"absolute",opacity:"0.8"}}></div>
            <div className='sixth_photo'>
              <svg className='photo_back' style={{ marginTop:"15%", marginLeft:"5%"}}></svg>
              <div className='sixth_photo-left'>
                <img src={avartar1} className="sixth-logo"/>
              ...
              <div className='sixth_photo-center'>
                <img src={avartar2} className="sixth-logo"/>
              ...
              <div className='sixth_photo-right'>
                <img src={avartar3} className="sixth-logo"/>
